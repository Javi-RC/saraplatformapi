describe('NotificationChannelFactory - Unit Tests', () => {
  ...
  beforeEach(() => {
    jest.resetModules();
    factory = require('../../../../../src/services/notification/channels/NotificationChannelFactory');
    factory.clearCache();
  });
  ...
  it('getChannel should throw for unknown channel type', () => {
    expect(() => factory.getChannel('unknown')).toThrow('Unknown notification channel: unknown');
  });
});
