...
jest.mock('../../../../src/services/notification/helpers/auth.helper');
...
describe('AuthService - Unit Tests', () => {
  ...
  beforeEach(() => {
    jest.resetModules();
    authService = require('../../../../src/services/auth/auth.service');
    ...
    const authNotificationHelper = require('../../../../src/services/notification/helpers/auth.helper');
