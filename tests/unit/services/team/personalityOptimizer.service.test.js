describe('personalityOptimizer.service - Unit Tests', () => {
  function setup({ profiles = [], synergyAvailable = true } = {}) {
    ...
    jest.doMock('../../../../src/repositories', () => ({ bfi44Repository: bfi44RepositoryMock }));
    jest.doMock('../../../../src/services/team/teamSynergy.service', () => teamSynergyServiceMock);

    const optimizer = require('../../../../src/services/team/personalityOptimizer.service');
    return { optimizer, bfi44RepositoryMock, teamSynergyServiceMock };
  }
