...
jest.mock('../../../../src/services/notification/helpers/organization.helper');
jest.mock('../../../../src/services/notification/helpers/bfi44.helper');

const organizationNotificationHelper = require('../../../../src/services/notification/helpers/organization.helper');
const bfi44NotificationHelper = require('../../../../src/services/notification/helpers/bfi44.helper');
...
describe('OrganizationService', () => {
  ...
  describe('addEmployee', () => {
    ...
    it('should throw error if user is not admin', async () => {
      ...
      ).rejects.toThrow('You do not have permission to add employees');
    });
  ...
  describe('removeEmployee', () => {
    ...
    it('should throw error if user is not admin', async () => {
      ...
      ).rejects.toThrow('You do not have permission to remove employees');
    });
  });
  ...
  describe('updateEmployeeStatus', () => {
    ...
    it('should throw error if user is not admin', async () => {
      ...
      ).rejects.toThrow('You do not have permission to update employee status');
    });
  });
});
