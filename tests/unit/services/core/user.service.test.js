const userService = require('../../../../src/services/core/user.service');
const userNotificationHelper = require('../../../../src/services/notification/helpers/user.helper');
...
jest.mock('../../../../src/services/notification/helpers/user.helper');
jest.mock('bcryptjs');
