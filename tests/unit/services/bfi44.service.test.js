...
describe('bfi44.service - Unit Tests', () => {
  ...
  it('validateResponses should reject wrong response count', () => {
    expect(() => BFI44Service.validateResponses({ 1: 3 })).toThrow('INVALID_RESPONSE_COUNT');
  });
  ...
  it('validateResponses should reject missing questions', () => {
    ...
    expect(() => BFI44Service.validateResponses(responses)).toThrow('MISSING_QUESTION_10');
  });
  ...
  it('validateResponses should reject values outside 1..5', () => {
    ...
    expect(() => BFI44Service.validateResponses(responses)).toThrow('INVALID_VALUE_QUESTION_1');
  });
  ...
  it('calculateFactorScore should throw when an item is missing in Map', () => {
    ...
    expect(() => BFI44Service.calculateFactorScore(map, 'Extraversion')).toThrow('MISSING_ITEM_11');
  });
