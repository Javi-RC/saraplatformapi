describe('notification.service - Unit Tests', () => {
  function setup() {
    ...
    jest.doMock('../../../src/services/notificationChannels/NotificationChannelFactory', () => NotificationChannelFactoryMock);
    jest.doMock('../../../src/services/email.service', () => ({ sendConfirmationEmail: jest.fn() }));
